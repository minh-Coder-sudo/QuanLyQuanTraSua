...
const storeData = [
  {
    province: 'Bạc Liêu',
    districts: ['Tất cả', 'Thành phố Bạc Liêu', 'Huyện Hồng Dân', 'Huyện Phước Long'],
    stores: [
      { id: 1, name: 'TEA MANGO NGÔ GIA H390', address: '84 Cao Văn Lầu, Phường 2, Bạc Liêu, Việt Nam', phone: '0943 907 490', district: 'Thành phố Bạc Liêu', lat: 9.2952, lng: 105.7237 },
      { id: 2, name: 'TEA MANGO NGÔ GIA H211', address: '174 Trần Phú, Phường 7, Bạc Liêu, Việt Nam', phone: '0342 995 489', district: 'Thành phố Bạc Liêu', lat: 9.2862, lng: 105.7248 },
      { id: 3, name: 'TEA MANGO HỒNG DÂN', address: '25 Hùng Vương, TT. Ngan Dừa, Hồng Dân, Bạc Liêu', phone: '0912 345 678', district: 'Huyện Hồng Dân', lat: 9.4421, lng: 105.5863 },
    ],
  ...
  {
    province: 'Cần Thơ',
    districts: ['Tất cả', 'Quận Ninh Kiều', 'Quận Bình Thủy', 'Quận Cái Răng'],
    stores: [
      { id: 4, name: 'TEA MANGO NINH KIỀU', address: '12 Hai Bà Trưng, Quận Ninh Kiều, Cần Thơ', phone: '0901 234 567', district: 'Quận Ninh Kiều', lat: 10.0358, lng: 105.7874 },
      { id: 5, name: 'TEA MANGO BÌNH THỦY', address: '56 Lê Hồng Phong, Quận Bình Thủy, Cần Thơ', phone: '0902 345 678', district: 'Quận Bình Thủy', lat: 10.0639, lng: 105.7480 },
      { id: 6, name: 'TEA MANGO CÁI RĂNG', address: '88 Nguyễn Văn Cừ, Quận Cái Răng, Cần Thơ', phone: '0903 456 789', district: 'Quận Cái Răng', lat: 10.0081, lng: 105.7682 },
    ],
  ...
  {
    province: 'Hà Nội',
    districts: ['Tất cả', 'Quận Hoàn Kiếm', 'Quận Đống Đa', 'Quận Cầu Giấy'],
    stores: [
      { id: 7, name: 'TEA MANGO HOÀN KIẾM', address: '36 Hàng Bài, Quận Hoàn Kiếm, Hà Nội', phone: '0241 234 567', district: 'Quận Hoàn Kiếm', lat: 21.0245, lng: 105.8412 },
      { id: 8, name: 'TEA MANGO ĐỐNG ĐA', address: '102 Nguyễn Lương Bằng, Đống Đa, Hà Nội', phone: '0242 345 678', district: 'Quận Đống Đa', lat: 21.0213, lng: 105.8366 },
      { id: 9, name: 'TEA MANGO CẦU GIẤY', address: '78 Cầu Giấy, Quận Cầu Giấy, Hà Nội', phone: '0243 456 789', district: 'Quận Cầu Giấy', lat: 21.0332, lng: 105.7945 },
    ],
  ...
  },
  {
    ...
    stores: [
      { id: 10, name: 'TEA MANGO QUẬN 1', address: '45 Nguyễn Huệ, Quận 1, TP. HCM', phone: '0281 234 567', district: 'Quận 1', lat: 10.7769, lng: 106.7009 },
      { id: 11, name: 'TEA MANGO QUẬN 3', address: '23 Võ Văn Tần, Quận 3, TP. HCM', phone: '0282 345 678', district: 'Quận 3', lat: 10.7724, lng: 106.6887 },
      { id: 12, name: 'TEA MANGO BÌNH THẠNH', address: '98 Bạch Đằng, Bình Thạnh, TP. HCM', phone: '0283 456 789', district: 'Quận Bình Thạnh', lat: 10.8101, lng: 106.7135 },
    ],
  ...
  {
    province: 'Đà Nẵng',
    districts: ['Tất cả', 'Quận Hải Châu', 'Quận Thanh Khê', 'Quận Sơn Trà'],
    stores: [
      { id: 13, name: 'TEA MANGO HẢI CHÂU', address: '10 Bạch Đằng, Quận Hải Châu, Đà Nẵng', phone: '0511 234 567', district: 'Quận Hải Châu', lat: 16.0668, lng: 108.2236 },
      { id: 14, name: 'TEA MANGO THANH KHÊ', address: '55 Điện Biên Phủ, Thanh Khê, Đà Nẵng', phone: '0512 345 678', district: 'Quận Thanh Khê', lat: 16.0721, lng: 108.2025 },
      { id: 15, name: 'TEA MANGO SƠN TRÀ', address: '33 Phạm Văn Đồng, Sơn Trà, Đà Nẵng', phone: '0513 456 789', district: 'Quận Sơn Trà', lat: 16.0748, lng: 108.2425 },
    ],
...
export default function Location() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen pt-24 pb-12">
          ...
          <div className="w-full lg:w-80 shrink-0 flex flex-col bg-white" style={{ borderRight: '1px solid #f1f5f9' }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                >
                  {provinceData.districts.map((d) => (
                    <option key={d} value={d}>{d === 'Tất cả' ? 'Chọn Quận/Huyện' : d}</option>
                  ))}
                </select>
              </div>
            </div>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: 16, background: '#f9fafb' }}>
              {filteredStores.length === 0 ? (
                <p style={{ fontSize: 13, color: '#6b7280', textAlign: 'center', marginTop: 32 }}>Không tìm thấy cửa hàng.</p>
              ) : (
      ...
      <div style={{ position: 'fixed', right: 16, bottom: 96, zIndex: 50, display: 'flex', flexDirection: 'column', gap: 8 }}>
        {[
          ...
          <button
            key={label}
            title={label}
            style={{ background: bg, color: '#fff', width: 40, height: 40, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', border: 'none', cursor: 'pointer', boxShadow: '0 2px 8px rgba(0,0,0,0.25)' }}
          >
            {icon}
          </button>
        ))}
