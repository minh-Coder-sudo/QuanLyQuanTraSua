...
export default function Location() {
    ...
    const provinceData = useMemo(() => storeData.find((p) => p.province === selectedProvince), [selectedProvince]);
    ...
    return (
        <div className="bg-slate-50 min-h-screen pt-24 pb-12 mt-5">
            <div className="mx-auto max-w-7xl px-4">
                ...
                >
                    {/* ── Left Panel ─────────────────────────────────────────────── */}
                    <div
                        className="w-full lg:w-80 shrink-0 flex flex-col bg-white"
                        ...
                        <div style={{ flex: 1, overflowY: 'auto', padding: 16, background: '#f9fafb' }}>
                            {filteredStores.length === 0 ? (
                                ...
                                filteredStores.map((store) => (
                                    ...
                                    >
                                        <p style={{ fontWeight: 700, color: '#111827', fontSize: 13, marginBottom: 6 }}>
                                            {store.name}
                                        </p>
                                        <div
                                            style={{
                                        ...
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                style={{ width: 13, height: 13, flexShrink: 0, color: '#1d4ed8' }}
                                                fill="none"
                                                viewBox="0 0 24 24"
                                                stroke="currentColor"
                                                strokeWidth={2}
                                            >
                                                <path
                                                    strokeLinecap="round"
                                                    strokeLinejoin="round"
                                                    d="M3 5a2 2 0 012-2h2.28a1 1 0 01.95.68l1.1 3.3a1 1 0 01-.23 1.05L7.5 9.5a16 16 0 006.98 6.98l1.47-1.62a1 1 0 011.05-.23l3.3 1.1a1 1 0 01.68.95V19a2 2 0 01-2 2C9.163 21 3 14.837 3 7V5z"
                                                />
                                            </svg>
                        ...
                        >
                            {[
                                ...
                                },
                                {
                                    label: 'Zalo',
                                    bg: '#0284c7',
                                    icon: <span style={{ fontSize: 11, fontWeight: 700 }}>Zalo</span>,
                                },
                                {
                                    label: 'Facebook',
                                    bg: '#2563eb',
