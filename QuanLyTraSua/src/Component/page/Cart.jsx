    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 pt-28 pb-10">
            <div className="max-w-4xl mx-auto bg-white/90 backdrop-blur p-6 rounded-3xl shadow-2xl border border-gray-100">
                {/* TITLE */}
                <h1 className="text-3xl font-bold mb-6 text-orange-500 flex items-center gap-2">🛒 Giỏ hàng của bạn</h1>

                {/* EMPTY */}
                {cart.length === 0 && <p className="text-gray-400 text-center py-10">Chưa có sản phẩm</p>}
                            ...
                            >
                                ...
                                <div className="flex items-center gap-4 w-1/2">
                                    ...
                                    <div>
                                        ...
                                        {/* SIZE */}
                                        <p className="text-sm text-gray-500">Size: {item.size?.label || 'Mặc định'}</p>
