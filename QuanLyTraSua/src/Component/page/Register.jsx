    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-xl bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-10 md:p-14 shadow-2xl relative z-10">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <h2 className="text-3xl font-black text-white text-center tracking-tight mb-2 uppercase">ĐĂNG KÝ MỚI</h2>
          <p className="text-white/40 text-sm font-medium uppercase tracking-[0.2em] text-center">Gia nhập cộng đồng TeaMango!</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2 col-span-1 md:col-span-2">
            <label className="text-white/60 text-xs font-bold uppercase tracking-widest ml-1">Họ và tên</label>
            <input 
              name="fullname"
              type="text" 
          ...
          <div className="space-y-2 col-span-1 md:col-span-2">
            <label className="text-white/60 text-xs font-bold uppercase tracking-widest ml-1">Địa chỉ Email</label>
            <input 
              name="email"
              type="email" 
          ...
          <div className="space-y-2">
            <label className="text-white/60 text-xs font-bold uppercase tracking-widest ml-1">Mật khẩu</label>
            <input 
              name="password"
              type="password" 
              placeholder="••••••••" 
          ...
          <div className="space-y-2">
            <label className="text-white/60 text-xs font-bold uppercase tracking-widest ml-1">Xác nhận</label>
            <input 
