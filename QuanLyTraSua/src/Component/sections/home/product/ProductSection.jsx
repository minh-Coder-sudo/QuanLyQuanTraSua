...
export default function ProductSection() {
    return (
        <section className="bg-[#ede7db] py-24">
            <h2 className="text-center text-5xl font-bold mb-20 text-black">“NHÀ” COLLECTION</h2>
                    ...
                    {products.map((item, index) => (
                        <div key={index} className="group">
                            <div className="overflow-hidden rounded-lg">
                                <img src={item.img} className="mx-auto transition duration-500 group-hover:scale-110" />
                            </div>
